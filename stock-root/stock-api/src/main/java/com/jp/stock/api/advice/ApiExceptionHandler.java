...
/**
 * This class handles exception for all the controllers.
 *
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   *
   * @param ex - StockMarketServiceException
   * @param webRequest
   * @return ResponseEntity
   */
  @ExceptionHandler(value = {StockMarketServiceException.class})
  protected ResponseEntity<Object> bussinessException(
      StockMarketServiceException ex, WebRequest webRequest) {
    logger.error(ex);
    if (null != ex.getCause()) {
  ...
  /**
   * This method will catch BAD_REQUEST exceptions thrown during the validation phase.
   *
