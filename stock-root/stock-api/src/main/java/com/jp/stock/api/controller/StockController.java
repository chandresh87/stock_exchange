...
import com.jp.stock.api.mapper.RequestModelMapper;
...
/**
 * Stock controller handling all api calls
 *
...
public class StockController implements StockAPI {
  ...
  public ResponseEntity<Message> getDividend(
      @RequestParam(value = "stock", required = true) String stockSymbol,
      @RequestParam(value = "price", required = true) BigDecimal marketPrice) {
    BigDecimal dividend =
